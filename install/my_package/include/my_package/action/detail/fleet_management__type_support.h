...
#ifndef MY_PACKAGE__ACTION__DETAIL__FLEET_MANAGEMENT__TYPE_SUPPORT_H_
#define MY_PACKAGE__ACTION__DETAIL__FLEET_MANAGEMENT__TYPE_SUPPORT_H_
...
#endif  // MY_PACKAGE__ACTION__DETAIL__FLEET_MANAGEMENT__TYPE_SUPPORT_H_
